...
![生成密钥](./.assets/2025-04-04_152319.webp)
...
![安装 nos2x](./.assets/2025-04-04_153834.webp)

右键 nos2x 的图标打开扩展选项:

![打开选项](./.assets/2025-04-04_153944.webp)

![nos2x 选项页面](./.assets/2025-04-04_154029.webp)

在 private key 下的输入框输入你刚刚生成的 nsec 然后保存

![保存私钥配置](./.assets/2025-04-04_154431.webp)

点击 show key encrypted 按钮:

![显示加密后的私钥按钮](./.assets/2025-04-04_154554.webp)

在出现的 password 输入框输入一个**只有你脑子里记住且永远不会记在其他地方包括密码管理器的密码作为 PIN**, 支持数字字母, 建议至少四位及以上.

![输入加密私钥的 PIN](./.assets/2025-04-04_154639.webp)

输入完成后点击 encrypt and show key, 显示被对称加密后的私钥:

![显示加密后的私钥](./.assets/2025-04-04_155240.webp)
...
![授权读取公钥](./.assets/2025-04-04_160520.webp)
...
![找不到用户资料](./.assets/2025-04-04_160656.webp)

点击上方导航栏的 **Metadata** 进入用户资料编辑器:

![Metadata](./.assets/2025-04-04_160822.webp)

填写用户资料表单:

![填写表单](./.assets/2025-04-04_161052.webp)
...
![填写示例](./.assets/2025-04-04_161850.webp)

此时密钥 nos2x 会弹出授权提示签署你的第一个事件:

![签署用户资料事件](./.assets/2025-04-04_161956.webp)
...
![进入中继配置](./.assets/2025-04-04_162414.webp)

![中继配置界面](./.assets/2025-04-04_162450.webp)

不用管 read 和 write 选项, 直接在输入框中输入以下几个推荐中继, 一个中继输入后点击 Add 再添加一行:

![输入中继示例](./.assets/2025-04-04_162637.webp)
...
![添加上方的中继示例](./.assets/2025-04-04_163317.webp)

然后点击 Save, 保存配置, 网站会请求密钥管理器 nos2x 签署事件

![签署事件](./.assets/2025-04-04_163432.webp)
...
![Nostr.moe](./.assets/2025-04-04_163924.webp)

点击左下角的 "登录" 按钮, 弹出登录弹窗, 选择 "浏览器插件登录":

![使用浏览器插件登录](./.assets/2025-04-04_164051.webp)
...
![授权读取公钥](./.assets/2025-04-04_164345.webp)

授权完成后你就成功登录到 Nostr.moe 社区了, 左下角不出意外会显示出你的头像和用户名:

![你的用户资料已经成功发布到 Nostr 网络](./.assets/2025-04-04_164515.webp)

点击一下就可以弹出二级窗口, 选择 "个人资料" 就可以看到你设置的所有资料了:

![查看自己的用户资料](./.assets/2025-04-04_164710.webp)

## 发布帖子 {#send-post}

还是在 Nostr.moe 社区, 点击左侧边栏的 "发布笔记" 开始编辑你的第一条正式帖子:

![编辑帖子](./.assets/2025-04-04_164853.webp)

随便写点什么, 可以传图片上去:

> Nostr 发图片的方式就是插入图片链接.

![插入图片](./.assets/2025-04-04_165202.webp)

点击 "发布笔记" 请求 nos2x 授权签署:

![开始签署事件](./.assets/2025-04-04_165304.webp)
...
![我笔记呢?](./.assets/2025-04-04_165501.webp)

不要惊恐不要失望, 点击你显示资料页栏目中的 "重新加载笔记" 看看:

![我真的是初音未来](./.assets/2025-04-04_165604.webp)
...
![确认你的中继配置](./.assets/2025-04-04_170555.webp)

不出意料的话, 这里很可能是空的:

![查看客户端实际读取到的中继配置](./.assets/2025-04-04_170640.webp)

所以你需要将[配置中继](#配置中继)小节的那些中继再次输入到客户端进行 "添加".

![二次确认中继配置](./.assets/2025-04-04_170919.webp)
